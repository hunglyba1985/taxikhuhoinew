...
//    self.userName.text = [LocationMode shareInstance].currentUserProfile.userNameId;
//
//    NSLog(@"user name id is %@",[LocationMode shareInstance].currentUserProfile.userNameId);
//
